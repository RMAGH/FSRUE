# 🚀 Unofficial Unreal Engine 5.8 Support

> **Maintained by RMA**
> This is an unofficial community update providing support for **Unreal Engine 5.8**.
> 
> **Key Technical Fixes & Improvements:**
> * **Codebase Refactoring:** Cleaned up and refactored multiple core files for better code quality and maintainability.
> * **Legacy Cleanup:** Removed support for old Unreal Engine versions to streamline execution and focus strictly on UE 5.8+.
> * **Engine Patch & RDG:** Updated engine patch files and adapted Render Dependency Graph (**RDG**) pipeline integration.
> * **Stability & Performance:** Applied general bug fixes and optimizations.
>
> ---
> 
> 💖 **Support Ongoing Maintenance**  
> Keeping this integration updated and stable across new Unreal Engine releases requires continuous work. If this patch saved your team weeks of work, consider supporting its maintenance:
> 
> [**Sponsor on GitHub**](https://github.com/sponsors/RMAGH) &nbsp;|&nbsp; [**Support on Ko-fi**](https://ko-fi.com/rmakf)
